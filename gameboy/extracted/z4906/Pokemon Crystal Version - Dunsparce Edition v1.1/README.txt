...
Added Cyndaquil to the list of wild Pokémon on Mt. Mortar and Mt. Silver after it had turned out I had forgotten to define an area where it could be caught.

New, yet currently unused trainer class "Professor" to be used in a future version with a battle against Professor Oak.

Made Sweet Kiss do damage to prevent all Fairy moves from being status only.

Squirtle and its subsequent evolutions can be found in the grass by the Lake of Rage and in the water of the Lake of Rage.

Pikachu can be found sooner in Route 46.

A changelog of wild Pokémon changes has been in this zipped folder.

You can patch this new version to your existing Dunsparce Edition ROM.
