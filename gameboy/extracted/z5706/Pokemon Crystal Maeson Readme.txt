 Pokemon Crystal Maeson - Public Version 1.3.1 - Internal Version 17.5
 
 IT IS RECOMMENDED TO READ THIS WITH NOTEPAD++, 
 BUT YOU DO YOU.
 
 Note: Older save files are compatible with this 
       update! Just put your team on your PC, and 
	   take it back for Stat updates. 
...
o-----------------o
 ...
 This new update is made to adress a number of things in order to 
 improve the hack. Changes are as follow:
 
 · Pokémon Stats retweaked to lower the total BST from 650 to 620 in 
   order to lower the overall bulkyness of the creatures, and to make 
   Stat spreads a bit less well rounded, so each species is a bit 
 ...
 · Several Text edits to accomodate these changes and a few "under-the-hood"
   changes and improvements. This obviously includes all the Information 
   provided by the Pokedex.
   
 · Because all of the above, NPC Pokémon had corrections being made, 
   ...
   game though, I think it'd be perfectly fine, as long as you re-do the 
   Movesets of your Pokémon. 
   
   
  1.2 Changes: 
  
 · Fixed a few mistakes here and there, nothing major though. Fixing 
   map borders so they don't look weird, typos, incorrect information, etc.
 ...
 · A rather big shakedown to Moves. A number have disappeared, like the 
   ...
   similar Dragon Tail) has been added among a couple more. 
 ...
 · Base Stat Totals adjusted from 620 to 600.
   ...
   I feel you end up creating Pokémon that are a bit too bloated.
   
   On the first public release I had a 650 BST, which caused such 
   "problem", every creature had high stats on everything, really.
   For later versions I lowered to 620 but I thought I could go
   a bit further.    
   
   So I retweaked every creature again, and I think I am more 
   satisfied with how Stats are spreaded now. I also re-designed
   some of them to take different roles.

   I also reworked the Stats for not-fully-evolved creatures to be 
   equal for first and second stages, the second being only slightly
   less powerful than the final Stage si it can keep with Pokémon 
 ...
 · Freeze Status Effect no longer exists, Frostbite replaces it. 
   ...
   since the beginning I wanted an "Special version" of Burn, but
   everytime I tried to code it, it could come as a glitchy mess.
   ...
   a tutorial on how to implement it, and I added to my hack. Now 
   I can see where I was commiting errors that led to the glitches.
 ...
 · I fixed a number of mistakes related on the Pokedex Information, 
   ...
   All the information on the extra txt files was also updated, to 
   reflect changes made to this version. 


 1.3 Additon 21/08/22:
 ...
 · I was approached by a couple of people that asked me if I could 
   ...
   places, that can be harmful for people with epilepsia and such.
   ...
   flash that occurs when a Shiny Pokémon appears on battle. 
 
 · The Main patches (the ones with the actual content) will have 
   the Poison flash removed too, but the battle animations intact. 
   ...
   background is pure white, and people play on screens that are 
 ...
 · The main patches now have the flashes taken out. 
 
 · I fixed an issue with the Clock Reset function. I 
   also made the button combination simpler (Hold Down 
   + B Button) and you no longer have to input a password 
   to reset the game. While I don't really enjoy the chance 
   for exploits, like amassing points from the Radio Quiz, 
   it's not like someone couldn't do it before if they wanted 
   to really do it.
 
 · I edited the game's palettes to change all uses of Pure 
   White (RGB 31, 31, 31) for a slightly less "White" tone 
   (RGB 30, 30, 30) on backgrounds in order to lower eye 
   strain as, by playing on backlighted screens it can tire 
   your sight, and most people will probably play this on 
   such screens, if not every one. It's probably not noticeable
   unless you compare, but it does make a difference on the 
   long run. It may depend on emulator settings, too.

 · I fixed one of the trades of the Traveling Monk, as he 
   asked for one Item, but the game looked for another.
 
 · I made Kurt's Apricorn Ball making instantaneous, as 
   waiting a day for his Pokeballs was a bit harsh having 
   in mind that getting Apricrons isn't that fast either.
  
  
 Probably it won't get many more though, as I've grown way too 
 detached to this franchise, no in small part by how it has been 
...
o-----------------o
 ...
 also use the extra patches included (on for each version)
 to remove the flashes during battles and while walking with 
 your Pokémon being poisoned. 
...
o-----------------------o
 ...
 of 600, making each all of them feel have the same potential overall.
...
o-----------------o
 ...
 A new change with 1.1 is the removal (for the most part) of Normal type in Pokémon. 
 It has been substituted by a new type, called Beast, and it shares the same traits 
 as the rest of the types, two weaknesses, three resistances. 
 
 The reason of making a new type instead of giving weaknesses and resistances to 
 Normal type is, beyond the fact that being "weak to Normal" sounds ridiculous, 
 this way I also avoid having one type with an absurd amount of moves to use with STAB, 
 so there's Beast Moves, and Normal Moves that act neutral for every species. 

 Offensive wise, each Type is effective against two Types, and is resisted by three, 
 one it being itself. Normal Moves as said, remain neutral to everything. 
