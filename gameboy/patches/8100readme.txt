...
v3.0 changes:
	...
	Officer Jenny, Melanie and Damian from Pokemon Yellow have been added in and will give you the two starters you did not start with.
	...
	Unique party menu icons for each Pokemon have been added. They are used on the naming and trading screens as well. 

	Mew has been added. You must follow the following steps exactly to catch him:
		-After receiving Cut from the Captain of the SS Anne, you must lose a battle to a trainer on the ship. This will teleport you away from the ship without it leaving.
		-After receiving both Surf and Strength, return to the SS Anne. Surf from the dock to the right to the landing there. 
		-Activate Strength and push the truck from the right. Mew is under the truck.
